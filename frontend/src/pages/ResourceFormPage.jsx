          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-purple-300 mb-3">Available From (Time)</label>
                  <input
                    type="time"
                    name="availableFrom"
                ...
                <div>
                  <label className="block text-sm font-semibold text-purple-300 mb-3">Available To (Time)</label>
                  <input
                    type="time"
                    name="availableTo"
